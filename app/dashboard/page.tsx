    ...
    <div className="container mx-auto px-4 py-6">
      ...
      {showAdminWarning && (
        <Alert className="mb-4 bg-yellow-50 border-yellow-200">
          ...
          <AlertTitle className="text-yellow-800">Admin Modu Aktif</AlertTitle>
          <AlertDescription className="text-yellow-700">
            Şu anda admin modundasınız. Bu sayfada yapılan değişiklikler gerçek kullanıcı verilerini etkileyebilir.
          </AlertDescription>
        </Alert>
      )}
      ...
      {/* Ana İçerik - Yükleme tamamlandığında göster */}
      {!loading && (
        <>
          {/* Başlık ve Butonlar */}
            ...
            <div className="space-y-4">
              ...
              <Card className="w-full overflow-hidden border-none bg-gradient-to-br from-background via-background to-background backdrop-blur supports-[backdrop-filter]:bg-background/60 hover:bg-gradient-to-br hover:from-background/80 hover:via-background hover:to-background transition-all duration-300 shadow-[0_0_15px_rgba(0,0,0,0.1)] hover:shadow-[0_0_25px_rgba(0,0,0,0.15)] rounded-xl">
                <CardHeader className="pb-2">
                  <div className="flex items-center justify-between">
                    <div>
                      <CardTitle className="text-lg">Harcama Kategorileri</CardTitle>
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-6 xl:grid-cols-9 mt-6">
            {/* Gelir-Gider Analizi */}
