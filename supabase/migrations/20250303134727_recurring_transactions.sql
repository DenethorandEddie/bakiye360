...
DO $$ BEGIN
    DROP POLICY IF EXISTS "Users can read own recurring transactions" ON recurring_transactions;
...
CREATE INDEX IF NOT EXISTS recurring_transactions_start_date_idx ON recurring_transactions(start_date);
