...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-10 items-center justify-center rounded-lg bg-transparent p-1 text-muted-foreground border-0 border-none border-b-0 border-t-0 border-l-0 border-r-0',
      className
    )}
    {...props}
  />
